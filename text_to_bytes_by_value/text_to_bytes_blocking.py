...
#
"""
Pass by value text_to_bytes based on the original text_to_bytes below.
...
With standard library json and base64 throughput is around 3341 x 5KB items/s
With ujson and pybase64 throughput is around 3672 x 5KB items/s
...
from lambda_runtime.lambda_runtime_blocking import launch  # Blocking Lambda runtime
